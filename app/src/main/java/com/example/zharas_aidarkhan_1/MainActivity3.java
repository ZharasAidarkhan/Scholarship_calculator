    ...
    public void calculate() {
        try {
            ...
            if (value4.floatValue() >= 100) {
                ...
                if (first < 50) {
                    ed1.setError("У вас слишком мало баллов по мид термам," +
                            " вы не допускаетесь на файнал");
                }
                if (second < 50) {
                    ed2.setError("У вас слишком мало баллов по мид термам," +
                            " вы не допускаетесь на файнал");
                }
            }
            ...
            if (fullname.isEmpty()) {
                ...
                ed2.setError("Введите баллы за 2-уя половину семестра (2nd Attestation): ");
